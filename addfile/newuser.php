...
if(isset($_POST['submit']))
{
	...
	$pdoResult=$con->prepare("INSERT INTO newuser(username,phone,address,city,pincode,email,password,user_img) VALUES ('$username','$phone','$address','$city','$pincode','$email','$password','$pro_img1')");
